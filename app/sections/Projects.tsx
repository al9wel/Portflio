...
import files from "../assets/images/files.jpg";
import hadramedia from "../assets/images/hadramedia.jpg";
...
const projects = [
  {
    ...
    tech: [
      ...
      <SiReactrouter key={5} className="size-6 sm:size-7" />,
      <SiReactquery key={6} className="size-6 sm:size-7" />,
    ],
    description: `A document archiving system developed for the Hadramout Coast Tax Office, featuring role-based access, secure retrieval, and automated workflows.`,
    features: [
      "Role-Based Authentication – Secure authentication flow with protected routes and session management.",
      "Clean & Scalable Feature-Based Architecture – Independent features with API, hooks, components, and pages for easy maintenance.",
      "Performance Optimization – Lazy loading, route-based code splitting, and smart caching for faster load times.",
  ...
  },
  {
    ...
    tech: [
      ...
      <SiRedux key={4} className="size-6 sm:size-7" />,
    ],
  ...
  },
  {
    ...
    tech: [
      ...
      <SiVite key={2} className="size-6 sm:size-7" />,
      <SiTailwindcss key={3} className="size-6 sm:size-7" />,
      <SiSupabase key={4} className="size-6 sm:size-7" />,
    ],
    description: `A modern news platform built with React and Supabase, featuring a powerful admin dashboard for managing news, articles, and published content.`,
    features: [
      "Powerful admin dashboard for news and article management",
  ...
  },
  {
    ...
    tech: [
      ...
      <SiTailwindcss key={3} className="size-6 sm:size-7" />,
      <SiI18Next key={4} className="size-6 sm:size-7" />,
    ],
...
const Projects = () => {
  return (
    <section id="projects" className="p-2 min-h-screen overflow-hidden">
      ...
      <div className="mt-12">
        <div className="relative my-6 h-[1px] w-full bg-gradient-to-r from-transparent via-gray-400 to-transparent dark:via-gray-600"></div>
