        ...
        <section id="about" className="p-2 min-h-screen overflow-hidden">
            ...
            <div className="grid grid-cols-5 gap-4">
                <motion.div
                    ...
                    className="bg-color8 h-75 sm:h-65 col-span-2 md:col-span-1 md:h-112 lg:h-76 xl:h-70  rounded-br-[30px] rounded-sm relative">
                ...
                <motion.div
                    ...
                    transition={{ duration: 2, ease: [0.23, 1, 0.32, 1], }}
                    className="bg-color8 h-75 sm:h-65 col-span-5 md:col-span-2 md:h-112 lg:h-76 xl:h-70  rounded-tl-[30px] p-2 pr-1 text-black/80 rounded-sm relative">
                ...
                <div className="col-span-7 md:col-span-2 relative">
                    ...
                    <motion.div
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-2 mt-4">
                            <div className="flex justify-start items-center gap-2">
                                <div className="w-10 h-10 bg-color4 rounded-md"></div>
                    ...
                    <motion.div
                        ...
                        className="bg-color8 mt-2 h-25 sm:h-20  md:h-25 overflow-hidden xl:h-20 rounded-bl-[30px] rounded-sm p-2 flex justify-center items-center gap-4 flex-wrap">
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">html</h3>
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">css</h3>
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">tailwind</h3>
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">express</h3>
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">laravel</h3>
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">flutter</h3>
                        <h3 className="rounded-full border bg-color7/10 border-black/80 w-fit p-1">c#</h3>
                    </motion.div>
                </div>
            </div>
            <div className="grid grid-cols-7 mt-2 gap-2">
                <motion.div
                    ...
                    transition={{ duration: 2, ease: [0.23, 1, 0.32, 1], }}
                    className="bg-color8 text-black/80 p-2 rounded-sm rounded-bl-[30px] relative col-span-7 md:col-span-4">
                    <div className="noise opacity-30"></div>
                ...
                <motion.div
                    ...
                    transition={{ duration: 2, ease: [0.23, 1, 0.32, 1], }}
                    className="bg-color8 text-black/80 h-fit p-2 rounded-sm rounded-tr-[30px] relative col-span-7 md:col-span-3">
                    <div className="noise opacity-30"></div>
                    <h1 className={`uppercase ${oswald.className} tracking-widest text-4xl `}>Socials</h1>
                    <div className="flex flex-wrap gap-6 mt-2">
                        <div>
                            <Link href={"mailto:sa.al9wel@gmail.com"} className=" socials flex justify-start items-center gap-2 mb-2">
                                <div className="p-[3px] text-color8 bg-black/70 rounded-md"><Mail size={20} /></div>
                                <p>Gmail</p>
                            </Link>
                            <Link href={"https://wa.me/+967736584524"} className="socials flex justify-start items-center gap-2">
                                <div className="p-[3px] text-color8 bg-black/70 rounded-md"><Phone size={20} /></div>
                                <p>Whatsapp</p>
                            </Link>
                        </div>
                        <div>
                            <Link href={"https://github.com/al9wel"} className=" socials flex justify-start items-center gap-2 mb-2 ">
                                <div className="p-[3px] text-color8 bg-black/70 rounded-md"><Github size={20} /></div>
                                <p>Githup</p>
                            </Link>
                            <Link href={"https://linkedin.com/in/al9wel"} className="socials flex justify-start items-center gap-2">
                                <div className="p-[3px] text-color8 bg-black/70 rounded-md"><Linkedin size={20} /></div>
                                <p>Linked in</p>
                            </Link>
                        </div>
                        <button className="bg-black/80 mt-2  hidden sm:block  rounded-md p-2 text-color8 hover:text-color6 cursor-pointer hover:bg-black/90 duration-300">Downlad CV</button>
                    </div>
                    <button className="bg-black/80 mt-2 sm:hidden  rounded-md p-2 text-color8 hover:text-color6 cursor-pointer hover:bg-black/90 duration-300">Downlad CV</button>
