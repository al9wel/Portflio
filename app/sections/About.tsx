...
const About = () => {
    // مشكله عند الشاشه الصغيره لازم تحلها
    ...
    // أنيميشن الشاشات المتوسطة والكبيرة (md وأكبر)
    ...
    // نختار الأنيميشن حسب حجم الشاشة
            ...
            <div className="grid grid-cols-7 mt-2 gap-2">
                ...
                <motion.div
                    ...
                    <div className="flex flex-wrap gap-6 mt-2">
                        ...
                        <button className="bg-black/80 mt-0 md:mt-2 lg:self-start xl:self-stretch  hidden sm:block  rounded-md p-2 text-color8 hover:text-color6 cursor-pointer hover:bg-black/90 duration-300">Downlad CV</button>
                    </div>
                    <button className="bg-black/80 mt-6 sm:hidden  rounded-md p-2 text-color8 hover:text-color6 cursor-pointer hover:bg-black/90 duration-300">Downlad CV</button>
